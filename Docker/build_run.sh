...
CONTAINER_ID=$(docker run --restart=on-failure --cpus=2 -it -p 3002:3002 -v ~/CARTA/Images/:/Images $IMAGE_NAME /Images --verbosity 6 --no_log --no_http --no_browser --debug_no_auth)
