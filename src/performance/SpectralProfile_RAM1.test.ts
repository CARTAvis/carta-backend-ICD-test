...
let threadNumber = 16;
let imageFilesGroup = [
    fileName.cube100FilesAfits,
    // fileName.cube100FilesBfits,
    // fileName.cube100FilesCfits,

    // fileName.cube100FilesAimage,
    // fileName.cube100FilesBimage,
    // fileName.cube100FilesCimage,

    // fileName.cube100FilesAhdf5,
    // fileName.cube100FilesBhdf5,
    // fileName.cube100FilesChdf5,
];
describe("Spectral profile performance:  1 user on 1 backend change image size", () => {    
