    ...
    addRequireTiles: [
        {
            ...
            // tiles: [67149831, 67149832, 67149833, 67149834, 67145738, 67141642, 67137546,67149830,67153926, 67153927, 67153928, 67153929, 67153930, 67153931, 67149835, 67145739, 67141643 , 67137547, 67133451, 67129355, 67129354, 67149829, 67153925, 67158021, 67158022, 67158023, 67158024, 67158025, 67158026, 67158027, 67158028,67153932,67149836,67145740,67141644,67137548,67133452, 67129356, 67125260, 67125259, 67125258,67149828,67153924, 67158020],
    ...
    assertItem.fileOpen.map((fileOpen: CARTA.IOpenFile, index) => {
        ...
        describe(`Go to "${assertItem.filelist.directory}" folder`, () => {
            ...
            describe(`open the file "${fileOpen.directory}/${assertItem.fileOpen[index].file}"`, () => {
                ...
                // assertItem.addRequireTiles[0].tiles.map((tilenumber, IndexTile) => {
                //     let newaddRequireTiles = assertItem.addRequireTiles[0];
                //     newaddRequireTiles.tiles = [assertItem.addRequireTiles[0].tiles[IndexTile]]
                //     // let tt: CARTA.RasterTileData;
                //     test(`test RASTER_TILE_DATA`, async () => {
                //         // console.log(assertItem.addRequireTiles[index].tiles[IndexTile])
                //         // console.log(tilenumber);
                //         await Connection.send(CARTA.AddRequiredTiles, newaddRequireTiles);
                //         let tt = await Connection.stream(1);
                //         console.log(tilenumber, tt);
                //     })
                // });
