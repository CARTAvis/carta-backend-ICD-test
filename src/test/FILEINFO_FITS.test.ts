        ...
        fileInfoExtended: {
            '0': {
                ...
                headerEntries: [
                    ...
                    { name: "EXTEND", value: "T", entryType: 2, numericValue: 1 },
                    {
                        name: "BSCALE",
                    ...
                    {
                        name: "DATE",
                        value: "2016-09-07T22:08:24.390000",
...
describe("FILEINFO_FITS: Testing if info of an FITS image file is correctly delivered by the backend", () => {
